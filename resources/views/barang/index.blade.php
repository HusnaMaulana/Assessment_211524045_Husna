...
<body>
  ...
  <div class="sidebar">
    ...
    <a href="" class="menu-item active"><i class="fas fa-home"></i> Barang</a>
  ...
  <div class="main-content">
    ...
    <div class="container">
      <a href="{{ route('barang.create') }}"><button class="add-button">Add</button></a>
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $barang->Stok }}</td>
                  <td>
                    <button><a class="edit" href="{{ route('barang.edit', $barang->id) }}" class="btn btn-danger" >Edit</a></button>
